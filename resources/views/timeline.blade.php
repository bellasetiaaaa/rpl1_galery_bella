...
<div class="wrapper">
  ...
  <nav class="navbar navbar-expand navbar-dark navbar-black">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" data-toggle="modal" data-target="#uploadmodal" class="nav-link btn btn-primary ">Upload Foto<i class="fas fa-upload"></i></a>
      </li>
    </ul>
    <!-- Right navbar links -->
              ...
              <div class="col-md-12">
                ...
                <div class="timeline">
                  ...
                  <div class="time-label">
                    <span class="bg-red">{{ $galery->tanggal }}</span>
                  </div>
                  <!-- /.timeline-label -->
                  <!-- timeline item -->
                  <div>
                    ...
                    <div class="timeline-item">
                      ...
                      <h3 class="timeline-header"><a href="#">{{ $galery->judul }}</h3>

                      <div class="timeline-body">
                        <img class="img-fluid" src="{{ asset('images/'.$galery->foto) }}" alt="photo" width="400" height="400">
                        <p>{{ $galery->deskripsi }}</p>
                      </div>
                      <div class="timeline-footer">
                        <a class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modalEdit{{ $galery->id }}">Edit</a>
                        <a class="btn btn-danger btn-sm" data-toggle="modal" data-target="#hapusfoto{{ $galery->id }}">Delete</a>
                        <a href="{{ asset('images/'.$galery->foto) }}" download class="btn btn-info btn-sm">Download</a>
                      </div>
                    </div>
                      ...
                      @method('PUT')
                        <div class="modal-body">
                          ...
                          <div class="form-group">
                            ...
                            <input type="ket" value="{{ $galery->deskripsi }}" name="deskripsi" class="form-control">
                          </div>
                          <div class="form-group">
        ...
        <div class="modal-content">
          ...
          @csrf
            <div class="modal-body">
              ...
              <div class="form-group">
                <label for="judul">Deskripsi</label>
                <input type="ket" name="deskripsi" class="form-control">
              </div>
              <div class="form-group">
                <label for="foto">Foto</label>
                <input type="file" name="foto"  class="form-control">
